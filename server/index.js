...
mongoose.connect("mongodb+srv://aviral:Aviral04@cluster0.cwdyke0.mongodb.net/?retryWrites=true&w=majority",{
...
app.get('/search', async(req, res) => {
    ...
    const details = await Flight.find({ source, destination, date })
